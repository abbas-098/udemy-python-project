...
if edit_task_button:
    if edit_ask_id:
        ...
        st.success(f'Successfully edit the task id {edit_ask_id}. Pleas refresh page', icon="✅")
    else:
...
if remove_task_button:
    if remove_task_id:
        ...
        st.success(f'Successfully removed the task id {edit_ask_id}. Pleas refresh page', icon="✅")
    else:
